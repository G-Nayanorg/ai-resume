      ...
      <aside className="hidden md:flex flex-col w-64 border-r bg-white/50 border-slate-200 h-screen sticky top-0">
        ...
        <nav className="flex-1 overflow-y-auto py-4 px-3 space-y-1">
          ...
          <NavItem
            ...
            label="Resumes"
            active={pathname.startsWith('/recruiter/resumes')}
          />
        </nav>
          ...
          <div className="flex items-center gap-4 ml-auto">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-3 pl-4 border-l border-slate-200 text-left hover:opacity-85 transition-opacity focus:outline-none cursor-pointer"
              >
        ...
        <DialogContent className="sm:max-w-md bg-white p-6 rounded-lg shadow-lg">
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="mt-1 text-sm font-semibold text-slate-900">{user?.name || "N/A"}</div>
            </div>
            <div>
            ...
            {user?.tenantId && (
              <div>
                <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider">Tenant Identifier</label>
                <div className="mt-1 text-xs font-mono text-slate-600 bg-slate-50 p-2 rounded border border-slate-100 break-all">
                  {user.tenantId}
                </div>
              </div>
            )}
          ...
          <div className="mt-6 flex justify-end">
            <button
              ...
              className="bg-primary text-white px-4 py-2 rounded text-sm font-medium hover:bg-primary/90 transition-colors shadow-sm cursor-pointer"
            >
              Close
            </button>
          </div>
          ...
          <form onSubmit={handlePasswordChange} className="space-y-4">
            ...
            <div className="mt-6 flex justify-end gap-2">
              ...
              <button
                type="submit"
                disabled={pwdLoading}
                className="bg-primary text-white px-4 py-2 rounded text-sm font-medium hover:bg-primary/90 transition-colors shadow-sm disabled:opacity-55 cursor-pointer"
              >
